...
namespace CoralVR
{
    public class LogManager : MonoBehaviour
    {
        ...
        //public CybersicknessPredictor cybersicknessPredictor;
        ...
        private void StartTracking()
        {
            ...
            if (enableHeadTracking)
            {
                _headTrackingStringBuilder =
                    _headTrackingAPI.TrackHead(time, frameCount, _activeCamera, _headTrackingStringBuilder,input);
            }

            if (enableEyeTracking)
            {
                _eyeTrackingStringBuilder = _eyeTrackingAPI.StartTracking(time, frameCount, _eyeTrackingStringBuilder,input);
            }
            ...
            //cybersicknessPredictor.PredictCybersickness(input);
        }
